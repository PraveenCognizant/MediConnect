...
public class DoctorWritesPrescriptionSeleniumTest extends BaseTest {
        ...
        public Object[][] doctorPrescriptionData() {
                // Keep doctor as Praveen (already used in existing tests)
                String doctorEmail = "praveendu@gmail.com";
                String doctorPassword = "Praveen@123";

                // Patient chosen from existing appointment flow test
                // IMPORTANT: this patient must exist in doctor-approved appointments.
                String patientEmail = "john@gmail.com";
                String patientPassword = "John@123";

                // In current app, prescription dropdown uses appointments.patientname
                // so we pass a patient name expectation that matches appointment.user name.
                // If your seed/test data differs, adjust only this patientName.
        ...
        @Test(dataProvider = "doctorPrescriptionData")
