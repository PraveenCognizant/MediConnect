...
public class DoctorRegistrationApprovalTest extends BaseTest {
    ...
    public Object[][] doctorRegistrationApprovalData() {
        String uniqueId = String.valueOf(System.currentTimeMillis());
        return new Object[][]{
                {
                        "Dr Auto " + uniqueId,
                        "doctor.auto." + uniqueId + "@example.com",
                        "Male",
                        "98765" + uniqueId.substring(uniqueId.length() - 5),
                        "Scientist",
                        "5",
                        "Automation Hospital",
                        "Bangalore",
    ...
    @Test(dataProvider = "doctorRegistrationApprovalData")
